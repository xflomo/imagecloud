...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // user_home
        if ($pathinfo === '/fotos') {
            return array (  '_controller' => 'MainBundle\\Controller\\DefaultController::userHomeSite',  '_route' => 'user_home',);
        }
        ...
        // logout 
        if ($pathinfo === '/logout') {
            return array (  '_controller' => 'MainBundle\\Controller\\SecurityController::logoutAction',  '_route' => 'logout ',);
        }
